...
# 
# Features:
#   - Single standalone .sh file (Self-contained, no external python file needed)
#   - Auto dependency check & installation (python3, requests, xml)
#   - Comprehensive guide translation: <title>, <sub-title>, <desc>, <category>
#   - TV & Sports Glossary + Season/Episode normalizer (S01E05 -> الموسم 1 الحلقة 5)
#   - Instant in-memory eEPGCache reload via local WebInterface (zero GUI reboot)
#   - Auto-cleans /tmp and exits cleanly
...
GLOSSARY = {
    ...
    "Formula 1": "فورمولا 1",
    "F1": "فورمولا 1",
    "Highlights": "أبرز اللقطات والملخص",
    "Pre-Match": "الاستوديو التحليلي قبل المباراة",
    "Post-Match": "الاستوديو التحليلي بعد المباراة",
    "Studio Analysis": "الاستوديو التحليلي",
    "Full Match": "المباراة كاملة",
    "Season": "الموسم",
    "Episode": "الحلقة",
    "Premiere": "عرض أول",
    "Action": "أكشن",
...
class EPGTranslator:
    ...
    def apply_glossary(self, text):
        ...
        res = re.sub(r'\bSeason\s*(\d+)\s*Episode\s*(\d+)\b', r'الموسم \1 الحلقة \2', res, flags=re.IGNORECASE)
